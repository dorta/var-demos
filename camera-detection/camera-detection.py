...
from opencv import put_info_on_frame, put_fps_on_frame
from utils import get_tensor, load_labels, Timer, Framerate
...
def open_video_capture(width = 640, height = 480, framerate = "30/1"):
    pipeline = "v4l2src device={} ! video/x-raw,width={},height={}," \
               ...
               "appsink".format(args['device'], width, height, framerate)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
          '--device',
          default='/dev/video1',
          help='device path to device, e.g.: /dev/video<x>')
