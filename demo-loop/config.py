...
DELEGATE_LIB = "/opt/demo-loop/assets/libneutron_delegate.so"
MODEL_CPU = "/opt/assets/demo-loop/yolov8n_quant.tflite"
MODEL_NPU = "/opt/assets/demo-loop/yolov8n_quant_neutron.tflite"
